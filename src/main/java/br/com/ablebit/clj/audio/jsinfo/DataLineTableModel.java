...
public class DataLineTableModel
extends LineTableModel
{
	private static final String[] DATA_LINE_COLUMN_NAMES =
	{
	...
	public Object getValueAt(int nRow, int nColumn)
	{
		...
		DataLine.Info	info = (DataLine.Info) getLineInfo(nRow);
		switch (nColumn)
		{
		case 2:
		...
		case 3:
			int	nMaxBufferSize = info.getMaxBufferSize();
			return (nMaxBufferSize == AudioSystem.NOT_SPECIFIED) ? "unlimited" : "" + nMaxBufferSize;
